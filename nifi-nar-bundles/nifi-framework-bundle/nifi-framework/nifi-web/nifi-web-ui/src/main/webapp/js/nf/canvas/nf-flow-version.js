...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        module.exports = nf.FlowVerison = factory(
            require("jquery"),
    ...
    function (
        ...
        var resetSaveFlowVersionDialog = function () {
            ...
            $("#save-flow-version-process-group-id")
                .removeData("versionControlInformation")
                .removeData("revision")
                .text("");
        ...
        var resetRevertLocalChangesDialog = function () {
            ...
            clearLocalChangesGrid(
                $("#revert-local-changes-table"),
                $("#revert-local-changes-filter"),
                $("#displayed-revert-local-changes-entries"),
                $("#total-revert-local-changes-entries"),
            );
        };
        ...
        var resetShowLocalChangesDialog = function () {
            clearLocalChangesGrid(
                $("#show-local-changes-table"),
                $("#show-local-changes-filter"),
                $("#displayed-show-local-changes-entries"),
                $("#total-show-local-changes-entries"),
            );
        };
         ...
         */
        var clearLocalChangesGrid = function (
            localChangesTable,
            filterInput,
            displayedLabel,
            totalLabel,
        ...
        var clearFlowVersionsGrid = function () {
            var importFlowVersionGrid = $("#import-flow-version-table").data(
                "gridInstance",
            );
        ...
        var resetImportFlowVersionDialog = function () {
            ...
            $("#import-flow-version-process-group-id")
                .removeData("versionControlInformation")
                .removeData("revision")
                .text("");
            ...
            return $.ajax({
                ...
                .done(function (registriesResponse) {
                    ...
                    if (nfCommon.isDefinedAndNotNull(registriesResponse.registries)) {
                        authorizedRegistries = registriesResponse.registries.filter(
                            function (registry) {
        ...
        var loadBuckets = function (
            ...
            return $.ajax({
                type: "GET",
                url:
                    "../nifi-api/flow/registries/" +
                    encodeURIComponent(registryIdentifier) +
                    "/buckets",
                dataType: "json",
            })
                .done(function (response) {
                    ...
                    if (
                        nfCommon.isDefinedAndNotNull(response.buckets) &&
                        response.buckets.length > 0
                    ) {
                        response.buckets.sort(function (a, b) {
                            if (
                                a.permissions.canRead === false &&
        ...
        var saveFlowVersion = function () {
            ...
            var processGroupRevision = $("#save-flow-version-process-group-id").data(
                "revision",
            );
            ...
            var versionControlInformation = $(
                "#save-flow-version-process-group-id",
            ).data("versionControlInformation");
            if (nfCommon.isDefinedAndNotNull(versionControlInformation)) {
                ...
                var selectedRegistry = $("#save-flow-version-registry-combo").combo(
                    "getSelectedOption",
                );
                var selectedBucket = $("#save-flow-version-bucket-combo").combo(
                    "getSelectedOption",
                );
            ...
            return $.ajax({
                ...
                url:
                    "../nifi-api/versions/process-groups/" +
                ...
                .done(function (response) {
                    if ("SYNC_FAILURE" === response.versionControlInformation.state) {
                        nfDialog.showOkDialog({
                            headerText: "Error",
                            dialogContent:
                                response.versionControlInformation.stateExplanation,
                        });
                    }
                })
                .fail(nfErrorHandler.handleAjaxError);
        ...
        var initImportFlowVersionTable = function () {
            ...
            var timestampFormatter = function (
                ...
                var date = new Date(
                    dataContext.timestamp + userTimeOffset + serverTimeOffset,
                );
            ...
            // initialize the grid
            var importFlowVersionGrid = new Slick.Grid(
                importFlowVersionTable,
                importFlowVersionData,
                importFlowVersionColumns,
                gridOptions,
            );
         ...
         * @param totalLabel
         */
        var initLocalChangesTable = function (
            localChangesTable,
            filterInput,
            displayedLabel,
            totalLabel,
            ...
            var filter = function (item, args) {
                ...
                var matchesDifferenceType =
                    item["differenceType"].search(filterExp) >= 0;
            ...
            var actionsFormatter = function (
                ...
                if (
                    dataContext.differenceType !== "Component Removed" &&
                    nfCommon.isDefinedAndNotNull(dataContext.processGroupId)
                ) {
                    markup +=
                        '<div class="pointer go-to-component fa fa-long-arrow-right" title="Go To"></div>';
                }
            ...
            // initialize the grid
            var localChangesGrid = new Slick.Grid(
                localChangesTable,
                localChangesData,
                localChangesColumns,
                gridOptions,
                ...
                if (localChangesGrid.getColumns()[args.cell].id === "actions") {
                    if (target.hasClass("go-to-component")) {
                        if (componentDifference.componentType === "Controller Service") {
                            nfProcessGroupConfiguration
                                .showConfiguration(componentDifference.processGroupId)
                                .done(function () {
                                    nfProcessGroupConfiguration.selectControllerService(
                                        componentDifference.componentId,
                                    );
                            ...
                            nfCanvasUtils
                                .showComponent(
                                    componentDifference.processGroupId,
                                    componentDifference.componentId,
                                )
                                .done(function () {
                                    localChangesTable.closest(".large-dialog").modal("hide");
        ...
        var showImportFlowVersionDialog = function (pt) {
            ...
            var registryCombo = $("#import-flow-version-registry-combo")
                ...
                .show();
            var bucketCombo = $("#import-flow-version-bucket-combo")
                .combo("destroy")
                .combo({
                    options: [
                        {
                ...
                .show();
            var flowCombo = $("#import-flow-version-name-combo")
                .combo("destroy")
                .combo({
                    options: [
                        {
            ...
            loadRegistries(
                $("#import-flow-version-dialog"),
                registryCombo,
                bucketCombo,
                flowCombo,
                selectBucketImportVersion,
                function (bucketEntity) {
                    return true;
                },
            ).done(function () {
                // show the import dialog
                $("#import-flow-version-dialog")
                    .modal("setHeaderText", "Import Version")
        ...
        var loadFlowDetails = function (
            ...
            return $.ajax({
                ...
                url:
                    ...
                    encodeURIComponent(registryIdentifier) +
                    "/buckets/" +
                    encodeURIComponent(bucketIdentifier) +
                    "/flows/" +
                    encodeURIComponent(flowIdentifier) +
                    "/details",
                dataType: "json",
            })
                .done(function (response) {
                    ...
                    if (response.versionedFlow.description) {
                        ...
                        if (
                            flowVersionDetailsEl.get(0).scrollHeight >
        ...
        var loadFlows = function (
            ...
            return $.ajax({
                ...
                .done(function (response) {
                    ...
                    if (
                        nfCommon.isDefinedAndNotNull(response.versionedFlows) &&
                    ...
                    // load the buckets
                    $("#import-flow-version-name-combo")
                        .combo("destroy")
                        .combo({
         ...
         * @param flowIdentifier
         */
        var selectVersionedFlow = function (
            registryIdentifier,
            bucketIdentifier,
            flowIdentifier,
        ) {
        ...
        var selectBucketImportVersion = function (selectedBucket) {
            ...
            if (nfCommon.isDefinedAndNotNull(selectedBucket.value)) {
                ...
                var selectedRegistry = $("#import-flow-version-registry-combo").combo(
                    "getSelectedOption",
                );
        ...
        var importFlowVersion = function () {
            ...
            var selectedBucket = $("#import-flow-version-bucket-combo").combo(
                "getSelectedOption",
            );
            var selectedFlow = $("#import-flow-version-name-combo").combo(
                "getSelectedOption",
            );
            ...
            var selectedVersion = importFlowVersionGrid.getDataItem(
        ...
        var changeFlowVersion = function () {
            ...
            var submitChangeRequest = function () {
                ...
                return $.ajax({
                    ...
                    url:
                        "../nifi-api/versions/update-requests/process-groups/" +
                        encodeURIComponent(processGroupId),
                    dataType: "json",
                    contentType: "application/json",
                })
            ...
            var completeChangeRequest = function () {
                if (cancelled === true) {
                    ...
                    $("#change-version-status-message").text(
                        "The change version request has been cancelled.",
                    );
        ...
        var getVersionControlInformation = function (processGroupId) {
            return $.Deferred(function (deferred) {
                if (processGroupId === nfCanvasUtils.getGroupId()) {
                    ...
                    if (
                        processGroup.permissions.canRead === true &&
         ...
         */
        var updateVersionControlInformation = function (
            processGroupId,
            versionControlInformation,
        ) {
            ...
            if (nfCanvasUtils.getGroupId() === processGroupId) {
                nfNgBridge.injector
                    .get("breadcrumbsCtrl")
                    .updateVersionControlInformation(
                        processGroupId,
                        versionControlInformation,
                    );
                nfNgBridge.digest();
            ...
            if (nfCanvasUtils.getGroupId() === processGroupId) {
                ...
                $.ajax({
                    ...
                    .done(function (response) {
                        ...
                        breadcrumbsCtrl.generateBreadcrumbs(
                            response.processGroupFlow.breadcrumb,
                        );
        ...
        var updateProgress = function (percentComplete) {
            ...
            // update the progress
            var label = $('<div class="progress-label"></div>').text(
                percentComplete + "%",
            );
            nfNgBridge.injector
                .get("$compile")(
                    $(
                        '<md-progress-linear ng-cloak ng-value="' +
                        percentComplete +
                        '" class="md-hue-2" md-mode="determinate" aria-label="Searching Queue"></md-progress-linear>',
                    ),
                )(nfNgBridge.rootScope)
        ...
        var loadLocalChanges = function (
                ...
                function (response) {
                    if (
                        ...
                        nfDialog.showOkDialog({
                            headerText: "Change Version",
                            dialogContent:
                                "This Process Group is not currently under version control.",
                        });
                    }
                },
            );
            var loadChanges = $.ajax({
                ...
                .done(function (response) {
                    if (
                        nfCommon.isDefinedAndNotNull(response.componentDifferences) &&
                        response.componentDifferences.length > 0
                    ) {
                        var totalDifferences = 0;
                        $.each(
                            response.componentDifferences,
                            function (_, componentDifference) {
                                $.each(
                                    componentDifference.differences,
                        ...
                        nfDialog.showOkDialog({
                            ...
                            dialogContent:
                                "This Process Group does not have any local changes.",
                        });
                    }
                })
                .fail(nfErrorHandler.handleAjaxError);
        ...
        var revertLocalChanges = function (processGroupId) {
            getVersionControlInformation(processGroupId)
                .done(function (response) {
                    if (
                        nfCommon.isDefinedAndNotNull(response.versionControlInformation)
                    ) {
                        ...
                        var completeRevertRequest = function () {
                            if (cancelled === true) {
                                // update the message to indicate successful completion
                                $("#change-version-status-message").text(
                                    "The revert request has been cancelled.",
                                );
                                ...
                                $.ajax({
                                    ...
                                    if (
                                        ...
                                        nfDialog.showOkDialog({
                                            ...
                                            dialogContent: nfCommon.escapeHtml(
                                                revertRequest.failureReason,
                                            ),
                                        });
                                    } else {
                                        // update the percent complete
        ...
        return {
                            ...
                            disabled: function () {
                                if ($("#save-flow-version-registry-combo").is(":visible")) {
                                    var selectedRegistry = $(
                                        "#save-flow-version-registry-combo",
                                    ).combo("getSelectedOption");
                                    var selectedBucket = $(
                                        "#save-flow-version-bucket-combo",
                                    ).combo("getSelectedOption");

                                    if (
                                        nfCommon.isDefinedAndNotNull(selectedRegistry) &&
                                        nfCommon.isDefinedAndNotNull(selectedBucket)
                                    ) {
                                        return (
                                            selectedRegistry.disabled === true ||
                    ...
                    buttons: [
                        {
                            ...
                            handler: {
                                click: function () {
                                    var processGroupId = $(
                                        "#revert-local-changes-process-group-id",
                                    ).text();
            ...
            showFlowVersionDialog: function (processGroupId, action) {
                ...
                return $.Deferred(function (deferred) {
                    getVersionControlInformation(processGroupId)
                        .done(function (groupVersionControlInformation) {
                            if (
                                nfCommon.isDefinedAndNotNull(
                                ...
                                // update the registry and bucket visibility
                                $("#save-flow-version-registry")
                                    .text(versionControlInformation.registryName)
                                    .show();
                                $("#save-flow-version-bucket")
                                    .text(versionControlInformation.bucketName)
                                    .show();

                                $("#save-flow-version-name")
                                    .text(versionControlInformation.flowName)
                                    .show();
                                nfCommon.populateField(
                                    "save-flow-version-description",
                                ...
                                $("#save-flow-version-process-group-id").data(
                                    "versionControlInformation",
                                    versionControlInformation,
                                );
                                ...
                                var registryCombo = $("#save-flow-version-registry-combo")
                                    ...
                                    .show();
                                var bucketCombo = $("#save-flow-version-bucket-combo")
                                    .combo("destroy")
                                    .combo({
                                        options: [
                                            {
                            ...
                            $("#save-flow-version-process-group-id")
                                .data(
                                    "revision",
                                    groupVersionControlInformation.processGroupRevision,
                                )
                                .text(processGroupId);
                        })
                        .fail(nfErrorHandler.handleAjaxError);
            ...
            showChangeFlowVersionDialog: function (processGroupId) {
                return $.Deferred(function (deferred) {
                    getVersionControlInformation(processGroupId)
                        .done(function (groupVersionControlInformation) {
                            if (
                                ...
                                // update the registry and bucket visibility
                                $("#import-flow-version-registry")
                                    .text(versionControlInformation.registryName)
                                    .show();
                                $("#import-flow-version-bucket")
                                    .text(versionControlInformation.bucketName)
                                    .show();
                                $("#import-flow-version-name")
                                    .text(versionControlInformation.flowName)
                                    .show();
                                ...
                                // record the versionControlInformation
                                $("#import-flow-version-process-group-id")
                                    .data("versionControlInformation", versionControlInformation)
                                    .data(
                                        "revision",
                                        groupVersionControlInformation.processGroupRevision,
                                    )
                                ...
                                loadFlowVersions(
                                    versionControlInformation.registryId,
                                    versionControlInformation.bucketId,
                                    versionControlInformation.flowId,
                                )
                                    .done(function () {
                                        deferred.resolve();
                                    })
                                    .fail(function () {
                                        nfDialog.showOkDialog({
                                            headerText: "Change Version",
                                            dialogContent:
                                                "Unable to load available versions for this Process Group.",
                                        });
                    ...
                    .done(function () {
                        // show the dialog
                        $("#import-flow-version-dialog")
                            .modal("setHeaderText", "Change Version")
                            .modal("setButtonModel", [
                                {
                                    buttonText: "Change",
                                    color: {
                                    ...
                                    $.ajax({
                                        ...
                                        .done(function (response) {
                                            ...
                                            nfDialog.showOkDialog({
                                                ...
                                                dialogContent:
                                                    "This Process Group is no longer under version control.",
                                            });
                                        })
                                        .fail(nfErrorHandler.handleAjaxError);
                                } else {
